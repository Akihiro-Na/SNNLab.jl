...
#function run_state2lambda_test()
    ...
    # 隣接行列
    w_input2critic::Matrix{FT} = rand(Ncritic,Ninput)
    ...
    for i in iter
        ...
        # LTPTrace
        update!(critic_ltp, critic_ltp.param, dt, input_synapses.Isyn, critic_neurons.spike)
        # w update
        ...
        # LTPTrace
        update!(actor_ltp, actor_ltp.param, dt, input_synapses.Isyn, actor_neurons.spike)
        # w update
        ...
        if mod1(i, savearr_input.sampling_step) == 1
            ...
            savearr_critic.Isynarr[savearr_input.idx, :] = critic_synapses.Isyn
